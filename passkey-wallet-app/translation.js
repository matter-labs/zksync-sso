...
export const ENGLISH = {
  ...
  dynamic: {
    l2DepsitTx: "L2 Deposit Tx",
    l2WithdrawTx: "L2 Withdrawal Tx",
    l1FinalizationTx: "L1 Finalization Tx",
    enterUserName: "Please enter your name",
    creating: "Creating...",
    failedToCreateKey: "Failed to create passkey:",
    createKey: "Create Passkey",
    deploying: "Deploying...",
    ...
    depositToAave: "Deposit to Aave",
    withdrawing: "Withdrawing...",
    withdrawFailed: "Withdrawal failed:",
    withdrawFromAave: "Withdraw from Aave",
    sending: "Sending...",
    interopFailed: "Interop failed:",
    sendMessage: "Send Message",
    notBridgedYet: "not bridged yet",
    ...
    pending: "Pending",
    finalized: "Finalized",
    deployAccountAlert: "Please deploy your account first",
    sendingBalance: "Sending entire balance:",
    gasPaid: "gas paid via ERC-4337",
    balanceFailed: "Failed to get balance",
    inputError: "Please enter recipient address and amount",
...
export const SPANISH = {
  ...
  dynamic: {
    l2DepsitTx: "Tx de depósito L2",
    l2WithdrawTx: "Tx de retiro L2",
    l1FinalizationTx: "Tx de finalización L1",
    enterUserName: "Por favor, introduce tu nombre",
    creating: "Creando...",
    failedToCreateKey: "Error al crear la passkey:",
    createKey: "Crear passkey",
    deploying: "Implementando...",
    deployFailed: "Error en la implementación:",
    deployAccount: "Implementar cuenta",
    ...
    sendETH: "Enviar ETH",
    balanceError: "Error al cargar el saldo",
    depositing: "Depositando...",
    depositFailed: "Error en el depósito:",
    depositToAave: "Depositar en Aave",
    withdrawing: "Retirando...",
    withdrawFailed: "Error en el retiro:",
    withdrawFromAave: "Retirar de Aave",
    sending: "Enviando...",
    interopFailed: "Error de interop:",
    sendMessage: "Enviar mensaje",
    notBridgedYet: "Aún no puenteado",
    refreshTokenBalances: "Actualizar saldos de tokens",
    aToB: "Red A → Red B",
    bToA: "Red B → Red A",
    ...
    deployAccountAlert: "Por favor, implementa tu cuenta primero",
    sendingBalance: "Enviando saldo completo:",
    gasPaid: "gas pagado vía ERC-4337",
    balanceFailed: "No se pudo obtener el saldo",
    inputError: "Por favor, introduce la dirección del destinatario y la cantidad",
    amountError: "Por favor, introduce una cantidad válida",
  },
};
...
export const PORTUGUESE_BR = {
  ...
  dynamic: {
    l2DepsitTx: "Tx de depósito L2",
    l2WithdrawTx: "Tx de saque L2",
    l1FinalizationTx: "Tx de finalização L1",
    enterUserName: "Por favor, insira seu nome",
    creating: "Criando...",
    failedToCreateKey: "Falha ao criar a passkey:",
    createKey: "Criar passkey",
    deploying: "Implantando...",
    deployFailed: "Falha na implantação:",
    deployAccount: "Implantar conta",
    ...
    sendETH: "Enviar ETH",
    balanceError: "Erro ao carregar o saldo",
    depositing: "Depositando...",
    depositFailed: "Falha no depósito:",
    depositToAave: "Depositar na Aave",
    withdrawing: "Sacando...",
    withdrawFailed: "Falha no saque:",
    withdrawFromAave: "Sacar da Aave",
    sending: "Enviando...",
    interopFailed: "Falha no interop:",
    sendMessage: "Enviar mensagem",
    notBridgedYet: "Ainda não bridgeado",
    refreshTokenBalances: "Atualizar saldos de tokens",
    aToB: "Rede A → Rede B",
    bToA: "Rede B → Rede A",
    tokenTransferFailed: "Falha na transferência de tokens:",
    transferTokens: "Transferir tokens",
    pending: "Pendente",
    finalized: "Finalizado",
    deployAccountAlert: "Por favor, implante sua conta primeiro",
    sendingBalance: "Enviando saldo total:",
    gasPaid: "gas pago via ERC-4337",
    balanceFailed: "Falha ao obter o saldo",
    inputError: "Por favor, insira o endereço do destinatário e o valor",
    amountError: "Por favor, insira um valor válido",
  },
};
