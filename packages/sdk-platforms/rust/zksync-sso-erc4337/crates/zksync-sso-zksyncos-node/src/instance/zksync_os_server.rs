...
pub const DEFAULT_L1_PORT: u16 = 8545;
pub const DEFAULT_RPC_PORT: u16 = 3050;
...
pub(crate) fn spawn_server_process(
    ...
    cmd.current_dir(repo_dir)
        .env("RPC__PORT", rpc_port.to_string())
        .env("GENERAL__L1_RPC_URL", format!("http://127.0.0.1:{l1_port}"));
