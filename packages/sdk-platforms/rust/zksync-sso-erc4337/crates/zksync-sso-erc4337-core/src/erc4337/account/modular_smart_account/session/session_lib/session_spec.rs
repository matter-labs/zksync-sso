...
impl From<SessionSpec> for SessionLibSessionSpec {
...
impl From<SessionLibSessionSpec> for SessionSpec {
    fn from(value: SessionLibSessionSpec) -> Self {
        SessionSpec {
            signer: value.signer,
...
mod tests {
    ...
    use crate::erc4337::account::modular_smart_account::session::{
        ...
        session_lib::session_spec::{
            call_spec::CallSpec, condition::Condition, constraint::Constraint,
            limit_type::LimitType, transfer_spec::TransferSpec,
            usage_limit::UsageLimit,
        },
    };
    use alloy::primitives::{
        FixedBytes, U256, address, aliases::U48, fixed_bytes,
    };
    ...
    fn test_session_spec_round_trip_conversion() {
        ...
        let original_session_spec = SessionSpec {
            ...
            expires_at: U48::from(1749040108u32),
