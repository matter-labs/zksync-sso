...
where
    P: Provider + Clone,
{
    // Priority: env override -> alto.json -> patched sim ep
    ...
    // Not found on-chain: deploy a fresh EntryPoint to the local anvil
...
mod tests {
    use crate::erc4337::{
        ...
        client::test_utils::{
            ...
            EntryPointConfig, EntryPointVersion,
        },
    };
