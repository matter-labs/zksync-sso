...
pub async fn deploy_account(
    ...
    let provider = {
        ...
        let expected_deploy_wallet_address =
            address!("f39Fd6e51aad88F6F4ce6aB8827279cffFb92266");
        eyre::ensure!(
            wallet_address == expected_deploy_wallet_address,
            "XDB - deploy_account - Deploy wallet address: {} does not match expected deploy wallet address: {}",
            wallet_address,
...
mod tests {
    ...
    // #[tokio::test]
    // async fn test_deploy_account_manually() -> Result<()> {
    //     // Arrange
    //     let (anvil_zksync, config, _) =
    //         spawn_node_and_deploy_contracts().await?;
    //     let node_url = &config.node_url;
    ...
    //     {
    //         let account_factory = args.clone().contracts.account_factory;
    //         println!(
    //             "XDB deploy_account - Using factory address: {}",
    //             account_factory
    //         );
    ...
    //     println!(
    //         "    XDB Public key (hex): 0x{}",
    //         hex::encode(&args.clone().credential.public_key)
    //     );
    //     println!(
    //         "    XDB args.credential.public_key: {:?}",
    //         args.clone().credential.public_key
    //     );
    //     println!(
    //         "    XDB args.credential.id: {:?}",
    //         args.clone().credential.id
    //     );
    //     println!(
    //         "    XDB args.expected_origin: {:?}",
    //         args.clone().expected_origin
    //     );
    //     println!(
    //         "XDB deploy_account - args.unique_account_id: {:?}",
    //         args.clone().unique_account_id
    //     );
    //     println!(
    //         "XDB deploy_account - args.paymaster: {:?}",
    //         args.clone()
    ...
    //         crate::utils::encoding::encode_passkey_module_parameters(
    //             crate::utils::encoding::PasskeyModuleParams {
    //                 passkey_id: args.clone().credential.id.clone(),
    //                 passkey_public_key: (public_key_x, public_key_y),
    //                 expected_origin: origin.clone(),
    //             },
    //         )
    ...
    //         crate::utils::encoding::encode_module_data(
    //             crate::utils::encoding::ModuleData {
    //                 address: args.clone().contracts.passkey,
    //                 parameters: encoded_passkey_parameters.clone(),
    //             },
    //         )
    //         .map_err(|e| eyre!("Failed to encode module data: {}", e))?;
    ...
    //     let initial_k1_owners =
    //         args.clone().initial_k1_owners.unwrap_or_default();
    //     println!(
    //         "XDB deploy_account - Initial k1 owners: {:?}",
    //         initial_k1_owners
    //     );
    ...
    //         if let Some(mut paymaster) = args.clone().paymaster {
    //             // If paymaster_input is empty, generate default input
    //             if paymaster.paymaster_input.is_empty() {
    //                 paymaster.paymaster_input = generate_paymaster_input(None)?;
    //             }
    ...
    //     println!(
    //         "XDB deploy_account - Transaction sent with hash: {}",
    //         tx_hash
    //     );
    ...
    //     let result = DeployedAccountDetails {
    //         address,
    //         unique_account_id,
    //         transaction_receipt,
    //     };
    ...
    //         deploy_unique_id::get_predicted_deployed_account_address(
    //             args.clone(),
    //             wallet_address,
    //             &config,
    //         )?;
    ...
    //     eyre::ensure!(
    //         predicted_deployed_account_address == result.address,
